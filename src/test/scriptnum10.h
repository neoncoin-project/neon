...
#ifndef NEON_TEST_SCRIPTNUM10_H
#define NEON_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Neon Core 0.10.0, for cross-comparison.
 */
public:
