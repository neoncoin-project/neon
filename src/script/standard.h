...
#ifndef NEON_SCRIPT_STANDARD_H
#define NEON_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a neon address
 */
...
/**
 * Generate a Neon scriptPubKey for the given CTxDestination. Returns a P2PKH
