...
//! Entry point for NeonApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NeonApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NeonGUI tests.
void AppTests::guiTests(NeonGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NeonGUI::consoleShown, this, &AppTests::consoleTests);
