    ...
    platformStyle(_platformStyle)
{
    ...
    // normal neon address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying neon address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &NeonAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
