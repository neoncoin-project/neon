...
#include <config/neon-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNeonURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NeonUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNeonURI(info));
}
