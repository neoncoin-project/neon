    ...
    mapper(nullptr)
{
    ...
    ui->neonAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->neonAtStartup);
    ...
    ui->neonAtStartup->setToolTip(ui->neonAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->neonAtStartup->setText(ui->neonAtStartup->text().arg(PACKAGE_NAME));

    ui->openNeonConfButton->setToolTip(ui->openNeonConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NeonUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->neonAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNeonConfButton_clicked()
{
