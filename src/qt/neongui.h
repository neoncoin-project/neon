...
#ifndef NEON_QT_NEONGUI_H
#define NEON_QT_NEONGUI_H
...
/**
  Neon GUI main class. This class represents the main window of the Neon UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NeonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NeonGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~NeonGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a neon wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
