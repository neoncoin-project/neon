...
#ifndef NEON_CRYPTO_CHACHA_POLY_AEAD_H
#define NEON_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@neon.
 *
 ...
 *
 * The chacha20-poly1305@neon combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@neon cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@neon are relatively fast in
...
#endif // NEON_CRYPTO_CHACHA_POLY_AEAD_H
