...
#ifndef NEON_WALLET_SCRIPTPUBKEYMAN_H
#define NEON_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Neon Core wallet was originally a collection of unrelated private
...
#endif // NEON_WALLET_SCRIPTPUBKEYMAN_H
