...
#ifndef NEON_UTIL_SETTINGS_H
#define NEON_UTIL_SETTINGS_H
...
//!       https://github.com/neon/neon/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored neon settings. This struct combines settings from the command line
