...
(define* (make-neon-cross-toolchain target
                                  #:key
...
desirable for building Neon Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-neon-cross-toolchain "i686-linux-gnu")
       (make-neon-cross-toolchain "x86_64-linux-gnu")
       (make-neon-cross-toolchain "aarch64-linux-gnu")
       (make-neon-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-neon-cross-toolchain "riscv64-linux-gnu"
