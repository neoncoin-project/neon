# Bootstrappable Neon Core Builds

This directory contains the files necessary to perform bootstrappable Neon
Core builds.
...
- 24GB of free disk space on the partition that the Neon Core git repository
  resides in
...
For a Neon Core depends development environment, simply invoke
...
From the top of a clean Neon Core repository:
...
To use dongcarl's substitute server for Neon Core builds after having
