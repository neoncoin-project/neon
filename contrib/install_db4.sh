...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the neon repository."
  exit 1
fi
...
# See https://github.com/neon/neon/issues/16064
...
echo 'When compiling neond, run `./configure` in the following way:'
echo
