...
By default, neond will dump mempool on shutdown and
...
class MempoolPersistTest(NeonTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent neond from writing mempool.dat to disk. Verify that `savemempool` fails")
