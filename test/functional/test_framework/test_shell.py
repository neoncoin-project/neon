...
class TestShell:
    """Wrapper Class for NeonTestFramework.

    The TestShell class extends the NeonTestFramework
    ...
    class __TestShell(NeonTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by NeonTestFramework child class.
            self.num_nodes = 1
