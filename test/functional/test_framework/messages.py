...
"""Neon test framework primitive and message structures
...
COIN = 1000000 # 1 neon in satoshis
...
# Objects that map to neond objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in neond
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in neond indicates these should be deserialized as blocks
