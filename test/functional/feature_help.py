...
"""Verify that starting neon with -h works as expected."""

from test_framework.test_framework import NeonTestFramework
from test_framework.util import assert_equal

class HelpTest(NeonTestFramework):
    ...
    def run_test(self):
        self.log.info("Start neon with -h for help text")
        ...
        self.log.info("Start neon with -version for version information")
        ...
        self.log.info("Start neond with -fakearg to make sure it does not start")
