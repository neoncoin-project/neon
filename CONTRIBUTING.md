Contributing to Neon Core
============================

The Neon Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/neon/neon/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Neon Core PR Review Club](https://neoncore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Neon Core development happens on IRC, in the
#neon-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/neon-core-dev/](http://www.erisian.com.au/neon-core-dev/)
and [http://gnusha.org/neon-core-dev/](http://gnusha.org/neon-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/neon-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to neon-qt
...
[Translation Process](https://github.com/neon/neon/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Neon Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Neon
Network Protocol consensus changes.

Whether a pull request is merged into Neon Core rests with the project merge
...
Patches that change Neon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Neon consensus, it must have been
...
https://github.com/neon/neon/pull/16189).

Also see the [backport.py script](
https://github.com/neon-core/neon-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Neon Core release.
